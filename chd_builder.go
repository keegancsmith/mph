...
func tryHash(hasher *chdHasher, seen map[uint64]bool, keys, values []uint64, indices []uint16, bucket *bucket, ri uint16, r uint64) bool {
...
func (b *CHDBuilder) Build() (*CHD, error) {
	...
	duplicates := make(map[uint64]struct{}, n)
